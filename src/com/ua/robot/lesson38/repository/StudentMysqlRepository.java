...
public class StudentMysqlRepository implements StudentRepository {
    ...
    private static final String DB_URL = "jdbc:mysql://robot-do-user-1968994-0.b.db.ondigitalocean.com:25060/olehhello";
    ...
    //    private static final String CREAT_DATABASE = "CREATE TABLE IF NOT EXISTS student (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(10), age INT, group_id INT)";
    private static final String CREAT_DATABASE = "CREATE TABLE IF NOT EXISTS student " +
            "(id INT AUTO_INCREMENT PRIMARY KEY, " +
            "name VARCHAR(10), " +
            "age INT, " +
            "group_id INT)";
    private static final String DROP_DATABASE = "DROP TABLE IF EXISTS student";
    ...
    public void dropDatabase() {
        ...
        try {
            ...
            ps = conn.prepareStatement(DROP_DATABASE);
            ps.execute();
            conn.commit();
    ...
    public void createDatabase() {
        ...
        try {
            conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            conn.setAutoCommit(false);
            ps = conn.prepareStatement(CREAT_DATABASE);
            ps.execute();
            conn.commit();
        } catch (SQLException e) {
            try {
